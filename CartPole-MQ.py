...
def replay():
    ...
    q, acts = network(next_state).max(1)
...
for e in range(epochs):
        ...
        if (e+1)%100==0:
            mean = mr/100
            qvalues.append(float(qvals / 100))
            qvals = 0
...
plt.plot(lossmeans)
plt.title("Mean Loss")
#plt.savefig('./Plots/CartPole-MQ/meanloss.png',bbox_inches='tight')
plt.figure(1)
plt.plot(rewardmeans,color="orange")
plt.title("Mean Reward")
#plt.savefig('./Plots/CartPole-MQ/meanreward.png',bbox_inches='tight')
plt.figure(2)
plt.plot(qvalues,color="red")
plt.title("Mean Q-Value")
#plt.savefig('./Plots/CartPole-MQ/meanqvalue.png',bbox_inches='tight')
plt.show()